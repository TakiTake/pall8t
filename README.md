...
sandbox = "full"       # what the *sandboxed* agent may do to your herdr session:
                       #   "full" (default) — the whole herdr CLI except host admin
                       #                      (`server stop`, `integration install`)
