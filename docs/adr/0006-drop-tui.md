...
- ~~apple/container#990 (RO mounts) resolved → mount reference repos ro directly (roadmap item 2).~~ **Fired** — #990 had in fact closed 2026-01-07, before this ADR was written. Done in [ADR-0009](0009-readonly-reference-mounts.md).
